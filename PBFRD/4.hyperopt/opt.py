...
def objective(trial):
	...
	for i in range(iternum):
		model = xgb.XGBRegressor(**params, random_state = 1234, use_label_encoder = False)
...
if __name__ == "__main__":
	...
	accuracy = 0
	for i in range(iternum):  
		clf = xgb.XGBRegressor(**study.best_params, random_state = 1234, use_label_encoder = False)
