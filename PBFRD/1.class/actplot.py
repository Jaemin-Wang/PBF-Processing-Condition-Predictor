...
if True:#for iteri in range(iternum):
	...
	#while r2val < 0.85 or r2val2 < 0.8:
		...
		#model = xgboost.XGBClassifier(n_estimators=4096, learning_rate=0.01)#, max_depth=6, min_child_weight=15, n_jobs=12)#reg_alpha=0, reg_lambda=1, n_estimators=1024, learning_rate=0.01, gamma=0, subsample=0.75, max_depth=5, min_child_weight=15)
		...
		#params = {'max_depth': 13, 'learning_rate': 0.0671, 'n_estimators': 3000, 'colsample_bytree': 0.98, 'colsample_bylevel': 0.94, 'colsample_bynode': 0.99, 'reg_lambda': 0.98, 'reg_alpha': 0.32, 'subsample': 0.95, 'min_child_weight': 2}
